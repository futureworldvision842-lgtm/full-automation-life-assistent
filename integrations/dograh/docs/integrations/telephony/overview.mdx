...
Dograh does not sell phone numbers or minutes. The phone service is always
...
<CardGroup cols={2}>
  <Card title="Use a telephony provider" icon="phone">
    ...
    credentials into Dograh, and call using their numbers. **Start here if you
    don't already run phone infrastructure.** Pick your provider from the list
    below.
  </Card>
  <Card title="Bring your own SIP" icon="server" href="/integrations/telephony/dograh-sip">
    Already have a SIP trunk or a PBX? Point it at Dograh and keep your existing
    carrier and numbers. Every organization is provisioned with a
    **Dograh Cloudonix SIP** connection for exactly this; self-hosted
