"""Dynamic Synthesized Skill: format_crypto"""
import json

MANIFEST = {
    "name": "format_crypto",
    "description": "Auto-synthesized skill for: Format crypto symbol",
    "parameters": {
        "type": "OBJECT",
        "properties": {
...
def run(parameters: dict, player=None, speak=None) -> str:
    ...
    result = f"Executed format_crypto with param1={param1} and val={val * 2}"
    return result
